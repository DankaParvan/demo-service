...
class SecurityConfiguration(
    ...
    override fun configure(http: HttpSecurity) {
        http
            ...
            .antMatchers(HttpMethod.PUT, "/items/{id}").hasAuthority("ACCESS")
            .antMatchers(HttpMethod.POST, "/items").hasAuthority("ACCESS")
            .antMatchers(HttpMethod.DELETE, "/items/{id}").hasAuthority("ACCESS")
